    ...
    <html lang="en" className="h-fit">
      ...
      >
        ...
        <div className="content-center flex flex-col justify-around  p-5 bg-white w-screen">
          <div className="flex md:space-x-8 space-x-4 py-4 px-2 justify-between items-center">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <div className="flex items-center justify-between hover:bg-primary/5 rounded-md cursor-pointer p-1"><div className="flex items-center space-x-2"><span className="w-8 h-8 rounded-md bg-primary/10 flex justify-center items-center"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" className="text-primary font-bold" height="24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5.854 4.854a.5.5 0 1 0-.708-.708l-3.5 3.5a.5.5 0 0 0 0 .708l3.5 3.5a.5.5 0 0 0 .708-.708L2.707 8zm4.292 0a.5.5 0 0 1 .708-.708l3.5 3.5a.5.5 0 0 1 0 .708l-3.5 3.5a.5.5 0 0 1-.708-.708L13.293 8z"></path></svg></span><span className="font-semibold">Agenda</span></div><span className="text-white bg-primary rounded-full px-2">1</span></div></a><a href="/dashboard/"><div className="flex items-center justify-between hover:bg-primary/5 rounded-md cursor-pointer p-1"><div className="flex items-center space-x-2"><span className="w-8 h-8 rounded-md bg-primary/10 flex justify-center items-center"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" className="text-primary font-bold" height="24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5.854 4.854a.5.5 0 1 0-.708-.708l-3.5 3.5a.5.5 0 0 0 0 .708l3.5 3.5a.5.5 0 0 0 .708-.708L2.707 8zm4.292 0a.5.5 0 0 1 .708-.708l3.5 3.5a.5.5 0 0 1 0 .708l-3.5 3.5a.5.5 0 0 1-.708-.708L13.293 8z"></path></svg></span><span className="font-semibold">Congés</span></div><span className="text-white bg-primary rounded-full px-2">0</span></div></a></div><div className="flex justify-end"><a className="text-primary bg-primary/10 rounded-md p-1 mt-5" href="/dashboard/notifications/">Voir tous</a></div></div></div></div><div className="relative w-fit"><div className="relative cursor-pointer lg:bg-white lg:text-black py-2 ml-2 px-2 text-xs md:text-md z-[999] rounded-md"><div><div className="flex items-center justify-between lg:space-x-4"><div className="">Yatouze</div><div><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-lg" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"></path></svg></div></div></div>
                              <ul className="
                        absolute transition-all 
                        p-0 right-0
                        top-10 ease-in-out delay-200
                        duration-500 bg-white shadow-sm h-0
                        hidden w-[14rem]
                    ">
                      <li className="hover:bg-primary hover:text-white py-2 px-4">Compte</li>
                    <li className="hidden">Paramètres</li>
                    <li className="hover:bg-primary hover:text-white py-2 px-4">Déconnexion</li>
                    </ul>
            </div>
          </div>
        </div></div></div>
